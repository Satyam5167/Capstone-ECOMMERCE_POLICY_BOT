...
st.set_page_config(
    page_title="E-Commerce FAQ Bot", page_icon="🛒", layout="centered"
)
st.title("🛒 E-Commerce FAQ Bot")
st.caption("AI-powered customer support 24/7 for online shoppers.")
...
with st.sidebar:
    st.header("🛒 About")
    st.write("AI-powered E-Commerce FAQ Bot. I can answer questions about returns, shipping, products, and general inquiries directly from our knowledge base.")
    st.divider()
...
if prompt := st.chat_input("Ask about returns, shipping, or products..."):
